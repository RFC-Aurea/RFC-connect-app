        ...
        VStack(alignment: .leading, spacing: 8) {
            HStack(spacing: 8) {
                Image(systemName: "exclamationmark.triangle.fill")
                    .foregroundColor(.red)
                Text("Red Flags – Seek Immediate Help")
                    .font(.subheadline.bold())
                    .foregroundColor(.red)
            }
            Text("If you experience severe pain, heavy bleeding, fever >38°C, or feel unsafe, contact your RFC clinical team or emergency services immediately.")
                .font(.caption)
                .foregroundColor(.primary)
            Button("Call RFC Clinical Team: 1-800-RFC-HELP") {}
                .font(.caption.bold())
                .foregroundColor(.red)
        }
        .padding(16)
